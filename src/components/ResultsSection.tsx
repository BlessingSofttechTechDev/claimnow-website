  ...
  return (
    <section className="relative w-full h-[1024px] bg-[#F0F5FF] overflow-hidden">
      ...
      <div className="absolute left-[12px] top-[231px] w-[598px] flex flex-col gap-2">
        ...
        <motion.div
          className="relative w-full h-[440px] bg-white rounded-[24px]"
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        <motion.div
          className="relative w-full h-[96px] bg-white rounded-[24px]"
      ...
      <div className="absolute left-[618px] top-[231px] w-[402px] h-[752px] flex flex-col gap-2">
        {/* 2X Faster Card */}
        <motion.div
          className="relative w-full flex-1 bg-[#F9FFDC] border border-[#C9DC69] rounded-[24px]"
        ...
        {/* Bottom Image Card */}
        <motion.div
          className="relative w-full flex-1 bg-white rounded-[24px] overflow-hidden"
          initial={{ opacity: 0, scale: 0.95 }}
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
